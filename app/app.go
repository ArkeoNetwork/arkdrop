...
import (
	...
	"github.com/ArkeoNetwork/arkdrop/docs"
)
...
type App struct {
	*baseapp.BaseApp
	...
	ArkdropKeeper arkdropmodulekeeper.Keeper
...
func New(
	...
	*/
	...
	app.ArkdropKeeper = *arkdropmodulekeeper.NewKeeper(
		appCodec,
		keys[arkdropmoduletypes.StoreKey],
		keys[arkdropmoduletypes.MemStoreKey],
		app.GetSubspace(arkdropmoduletypes.ModuleName),
	)
	arkdropModule := arkdropmodule.NewAppModule(appCodec, app.ArkdropKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(arkdropmoduletypes.ModuleName)
